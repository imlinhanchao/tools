...
const input = ref('Hello, 世界! This is a test string.')
const output = ref('')
const key = ref('mySecretKey12345')
...
const modeOptions = ['CBC', 'ECB', 'CFB', 'OFB', 'CTR']
...
function process() {
  try {
    ...
    const encrypted = CryptoJS.AES.encrypt(input.value, keyParsed, options)
  ...
  <div class="tool-container">
    <div class="options-row">
      ...
      <div class="option-item" v-if="showIv">
        <div class="option-label">IV (初始向量)</div>
        <el-input v-model="iv" placeholder="输入IV" style="width:200px" />
      </div>
      <div class="option-item">
