...
function process() {
  try {
    ...
    const result = sm4.decrypt(input.value.trim(), key.value.trim(), {
      inputEncoding: inputEncoding.value as 'hex' | 'base64',
      outputEncoding: 'utf8',
    })
    output.value = result
  ...
  <div class="tool-container">
    <div class="options-row">
      ...
      <div class="option-item">
        ...
        <el-select v-model="inputEncoding" style="width:120px">
